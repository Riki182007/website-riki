...
<head>
    ...
    <style>
        ...
        body {
  background-color: turquoise; /* Ganti dengan kode warna yang diinginkan */
}
    </style>
</head>
    ...
    <header>
        <nav class="navbar navbar-expand-lg bg-light shadow" data-bs-theme="light">
            <div class="container-fluid mx-5">
                <!-- Logo -->
                <a class="navbar-brand" href="index.php">HayuFutsaL</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-3">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="https://wa.me/6283852721647">KONTAK</a>
                        </li>
                        <li class="nav-item">
